...
async function prerenderRoute(browser, base, route) {
  ...
  try {
    // If your backend has a cold-start delay (serverless, free-tier host),
    // give this real headroom beyond Puppeteer's 30s default.
    ...
    // Swap '.spin' for whatever loading-state selector your app uses.
